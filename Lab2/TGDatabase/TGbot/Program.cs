...
namespace TGBot
{
    class Program
    {
        ...
        private static bool equals (String str)
        {
            bool res = false;
            char[] recos =str.ToCharArray();
            char[] list = { 'L','i','s','t' };
        ...
        private static async void BotOnMessageReceived(object sender, MessageEventArgs e)
        {
            ...
            {
                await client.SendTextMessageAsync(message.Chat.Id, "Please enter list");   
            }
            if (equals(e.Message.Text))
            {
                await client.SendTextMessageAsync(message.Chat.Id, "Corect!!");
            }
            {
                await client.SendTextMessageAsync(message.Chat.Id, "Succes");
            }
